const { PlanVersionStatus, PrismaClient, SubscriptionStatus, UserRole, VendorStatus } = require("@prisma/client");
...
async function main() {
  ...
  await prisma.staffService.upsert({
    where: { staffId_serviceId: { staffId: staff.id, serviceId: cleaning.id } },
    update: {},
    create: { staffId: staff.id, serviceId: cleaning.id }
  });
